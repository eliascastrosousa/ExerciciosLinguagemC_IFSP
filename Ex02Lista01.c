/* Exercício intermediário Sequencia: Faça um algoritmo para receber dois valores e mostre o resultado das operações de: subtração,
 multiplicação e divisão para os valores recebidos. */
